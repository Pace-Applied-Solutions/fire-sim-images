 ...
 */
function getFlameHeightQualifier(flameHeightM) {
    if (flameHeightM < 0.5) {
 ...
 */
export const VIEWPOINT_PERSPECTIVES = {
    ...
    ground_north: "You're standing on the ground to the north of the fire, looking south towards the approaching flame front. Ground-level photograph taken at eye level, approximately 500 metres from the fire edge",
    ground_south: "You're standing on the ground to the south of the fire, looking north across the burned area towards the active fire line. Ground-level photograph showing the burned area with fire visible in the distance",
    ground_east: "You're standing on the ground to the east of the fire, looking west at the flank of the fire. Ground-level photograph taken at eye level, capturing the fire's flank and smoke movement",
    ground_west: "You're standing on the ground to the west of the fire, looking east at the flank of the fire. Ground-level photograph taken at eye level, capturing the fire's flank and smoke movement",
 ...
 */
export const FIRE_STAGE_DESCRIPTIONS = {
    spotFire: 'spot fire',
...
export const DEFAULT_PROMPT_TEMPLATE = {
    ...
    sections: {
        ...
        style: 'Create a photorealistic photograph for a fire service training exercise. ' +
        ...
        behaviorPrinciples: 'FIRE BEHAVIOUR FUNDAMENTALS:\n\n' +
        ...
        referenceImagery: (data) => {
            ...
            return (`Reference imagery context: You have access to a 3D interactive map (Google Maps style) displaying this specific location. ` +
        ...
        locality: (data) => {
            ...
            return (`Geographic context: ${localityText} ` +
        ...
        terrain: (data) => `Terrain: ${data.terrainDescription}. ` +
        ...
        features: (data) => `Nearby features: ${data.nearbyFeatures} ` +
        ...
        vegetation: (data) => {
            ...
            return (`Vegetation type: ${data.vegetationType}. ` +
        ...
        fireGeometry: (data) => {
            ...
            return (`Fire extent from reference map: ${areaDesc} ${extentDesc} ${shapeDesc} ` +
        ...
        fireBehavior: (data) => {
            ...
            return (`Fire behavior: A ${data.fireStage} is burning through the vegetation. ` +
                `${qualifier}. ` +
                `${flameDesc}${rosDesc} ` +
        ...
        weather: (data) => `Weather conditions: Temperature ${data.temperature}°C, relative humidity ${data.humidity}%, ` +
            `${data.windDescription}. ` +
            `${data.timeOfDayLighting}.`,
        // Section 11: Set camera position and framing
        perspective: (viewpoint) => `Camera position: ${VIEWPOINT_PERSPECTIVES[viewpoint]}.`,
        // Section 12: Safety constraints and scene composition
        safety: 'Render the landscape as visible in the reference imagery: include all natural terrain, vegetation, fire, and smoke. ' +
