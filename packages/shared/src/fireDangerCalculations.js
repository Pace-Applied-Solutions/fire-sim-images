 ...
 */
export const RATING_WEATHER_PROFILES = {
    noRating: {
        temperature: 18,
        humidity: 60,
        windSpeed: 8,
 ...
 */
export const FIRE_BEHAVIOUR_BY_VEGETATION = {
    'Dry Sclerophyll Forest': {
        ...
        extreme: {
            ...
            intensity: 'veryHigh',
            descriptor: 'Very intense fire with 8-20m towering flames, dense black smoke column, heavy spotting',
        },
        catastrophic: {
            ...
            intensity: 'extreme',
            descriptor: 'Catastrophic fire intensity with 20+ meter flames, pyrocumulonimbus development, extreme spotting and fire whirls',
        },
    },
    Grassland: {
        noRating: {
 ...
 */
export function getWeatherProfileForRating(rating) {
 ...
 */
export function getFireBehaviour(rating, vegetationType) {
...
//# sourceMappingURL=fireDangerCalculations.js.map